...
class UsersResource_GetProfileMethod : public GmailServiceBaseRequest {
 public:
  ...
  UsersResource_GetProfileMethod(
      ...
      const nonstd::string_view& user_id);
...
class UsersResource_MessagesResource_AttachmentsResource_GetMethod : public GmailServiceBaseRequest {
 public:
  ...
  UsersResource_MessagesResource_AttachmentsResource_GetMethod(
      ...
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const nonstd::string_view& message_id,
      const nonstd::string_view& id);
...
/**
 * Implements the getLanguage method.
 *
 * @ingroup ServiceMethod
 *
 * This class uses the Command Pattern. Construct an instance with the required
 ...
 * https://www.googleapis.com/auth/gmail.settings.basic
 */
class UsersResource_SettingsResource_GetLanguageMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * to indicate the authenticated user.
   */
  UsersResource_SettingsResource_GetLanguageMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id);
   ...
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_GetLanguageMethod();
 ...
 private:
  string user_id_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_GetLanguageMethod);
};
...
/**
 * Implements the updateLanguage method.
 *
 * @ingroup ServiceMethod
 *
 * This class uses the Command Pattern. Construct an instance with the required
 ...
 * https://www.googleapis.com/auth/gmail.settings.basic
 */
class UsersResource_SettingsResource_UpdateLanguageMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * @param[in] user_id User's email address. The special value "me" can be used
   * to indicate the authenticated user.
   * @param[in] _content_ The data object to updateLanguage.
   */
  UsersResource_SettingsResource_UpdateLanguageMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const LanguageSettings& _content_);

  /**
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_UpdateLanguageMethod();
 ...
 private:
  string user_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_UpdateLanguageMethod);
};
 ...
 * https://www.googleapis.com/auth/gmail.settings.sharing
 */
class UsersResource_SettingsResource_DelegatesResource_CreateMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * @param[in] _content_ The data object to create.
   */
  UsersResource_SettingsResource_DelegatesResource_CreateMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const Delegate& _content_);

  /**
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_DelegatesResource_CreateMethod();
 ...
 private:
  string user_id_;  string _content_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_DelegatesResource_CreateMethod);
};
 ...
 * https://www.googleapis.com/auth/gmail.settings.sharing
 */
class UsersResource_SettingsResource_DelegatesResource_DeleteMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * @param[in] user_id User's email address. The special value "me" can be used
   * to indicate the authenticated user.
   * @param[in] delegate_email The email address of the user to be removed as a
   * delegate.
   */
  UsersResource_SettingsResource_DelegatesResource_DeleteMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const nonstd::string_view& delegate_email);

  /**
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_DelegatesResource_DeleteMethod();
 ...
 private:
  string user_id_;
  string delegate_email_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_DelegatesResource_DeleteMethod);
};
 ...
 * https://www.googleapis.com/auth/gmail.settings.basic
 */
class UsersResource_SettingsResource_DelegatesResource_GetMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * @param[in] user_id User's email address. The special value "me" can be used
   * to indicate the authenticated user.
   * @param[in] delegate_email The email address of the user whose delegate
   * relationship is to be retrieved.
   */
  UsersResource_SettingsResource_DelegatesResource_GetMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const nonstd::string_view& delegate_email);
   ...
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_DelegatesResource_GetMethod();
 ...
 private:
  string user_id_;
  string delegate_email_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_DelegatesResource_GetMethod);
};
 ...
 * https://www.googleapis.com/auth/gmail.settings.basic
 */
class UsersResource_SettingsResource_DelegatesResource_ListMethod : public GmailServiceBaseRequest {
 public:
  /**
   * The standard constructor takes all the required method parameters.
   * @param[in] _service_  The service instance to send to when executed.
   ...
   * to indicate the authenticated user.
   */
  UsersResource_SettingsResource_DelegatesResource_ListMethod(
      const GmailService* _service_,
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id);
   ...
   * Standard destructor.
   */
  virtual ~UsersResource_SettingsResource_DelegatesResource_ListMethod();
   ...
   */
  util::Status ExecuteAndParseResponse(
      ListDelegatesResponse* data) {
    return GmailServiceBaseRequest::ExecuteAndParseResponse(data);
  }

 private:
  string user_id_;
  DISALLOW_COPY_AND_ASSIGN(UsersResource_SettingsResource_DelegatesResource_ListMethod);
};
...
class UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod : public GmailServiceBaseRequest {
 public:
  ...
  UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod(
      ...
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const nonstd::string_view& forwarding_email);
...
class UsersResource_SettingsResource_SendAsResource_DeleteMethod : public GmailServiceBaseRequest {
 public:
  ...
  UsersResource_SettingsResource_SendAsResource_DeleteMethod(
      ...
      client::AuthorizationCredential* _credential_,
      const nonstd::string_view& user_id,
      const nonstd::string_view& send_as_email);
 ...
 public:
    ...
    class DraftsResource {
     public:
      ...
      UsersResource_DraftsResource_CreateMethod* NewCreateMethod(
          client::AuthorizationCredential* _credential_,
          const nonstd::string_view& user_id) const;
     ...
     public:
      ...
      class DelegatesResource {
       public:
         ...
         *            the service that methods are invoked on.
         */
        explicit DelegatesResource(GmailService* service);
         ...
         *           then destroy it when they are finished.
         */
        UsersResource_SettingsResource_DelegatesResource_CreateMethod* NewCreateMethod(
            client::AuthorizationCredential* _credential_,
            const nonstd::string_view& user_id,
            const Delegate& _content_) const;
         ...
         * @param[in] user_id User's email address. The special value "me" can
         * be used to indicate the authenticated user.
         * @param[in] delegate_email The email address of the user to be removed
         * as a delegate.
         * @returns  The caller should <code>Execute</code> the method instance,
         *           then destroy it when they are finished.
         */
        UsersResource_SettingsResource_DelegatesResource_DeleteMethod* NewDeleteMethod(
            client::AuthorizationCredential* _credential_,
            const nonstd::string_view& user_id,
            const nonstd::string_view& delegate_email) const;

        /**
         * Creates a new
         * UsersResource_SettingsResource_DelegatesResource_GetMethod instance.
         *
         * @param[in] _credential_  Can be NULL.
         *            NULL credentials will not authorize the request.
         * @param[in] user_id User's email address. The special value "me" can
         * be used to indicate the authenticated user.
         * @param[in] delegate_email The email address of the user whose
         * delegate relationship is to be retrieved.
         * @returns  The caller should <code>Execute</code> the method instance,
         *           then destroy it when they are finished.
         */
        UsersResource_SettingsResource_DelegatesResource_GetMethod* NewGetMethod(
            client::AuthorizationCredential* _credential_,
            const nonstd::string_view& user_id,
            const nonstd::string_view& delegate_email) const;
        ...
        /**
         * Creates a new
         * UsersResource_SettingsResource_DelegatesResource_ListMethod instance.
         *
         * @param[in] _credential_  Can be NULL.
         *            NULL credentials will not authorize the request.
         * @param[in] user_id User's email address. The special value "me" can
         ...
         *           then destroy it when they are finished.
         */
        UsersResource_SettingsResource_DelegatesResource_ListMethod* NewListMethod(
            client::AuthorizationCredential* _credential_,
            const nonstd::string_view& user_id) const;
       ...
       private:
        ...
        DISALLOW_COPY_AND_ASSIGN(DelegatesResource);
      };
      /**
       * Gets the delegates resource method factory.
       *
       * @return DelegatesResource for creating methods.
       */
      ...
      class ForwardingAddressesResource {
       public:
        ...
        UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod* NewDeleteMethod(
            client::AuthorizationCredential* _credential_,
            const nonstd::string_view& user_id,
            const nonstd::string_view& forwarding_email) const;
       ...
       public:
        ...
        class SmimeInfoResource {
         public:
           ...
           * @param[in] _credential_  Can be NULL.
           *            NULL credentials will not authorize the request.
           * @param[in] user_id The user's email address. The special value me
           * can be used to indicate the authenticated user.
           * @param[in] send_as_email The email address that appears in the
           * "From:" header for mail sent using this alias.
           * @param[in] id The immutable ID for the SmimeInfo.
           * @returns  The caller should <code>Execute</code> the method
           * instance,
           *           then destroy it when they are finished.
           */
          ...
          UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_ListMethod* NewListMethod(
              client::AuthorizationCredential* _credential_,
              const nonstd::string_view& user_id,
              const nonstd::string_view& send_as_email) const;
      ...
      /**
       * Creates a new UsersResource_SettingsResource_GetLanguageMethod
       * instance.
       *
       * @param[in] _credential_  Can be NULL.
       *            NULL credentials will not authorize the request.
       ...
       *           then destroy it when they are finished.
       */
      UsersResource_SettingsResource_GetLanguageMethod* NewGetLanguageMethod(
          client::AuthorizationCredential* _credential_,
          const nonstd::string_view& user_id) const;
      ...
      /**
       * Creates a new UsersResource_SettingsResource_UpdateLanguageMethod
       * instance.
       *
       * @param[in] _credential_  Can be NULL.
       *            NULL credentials will not authorize the request.
       ...
       *           then destroy it when they are finished.
       */
      UsersResource_SettingsResource_UpdateLanguageMethod* NewUpdateLanguageMethod(
          client::AuthorizationCredential* _credential_,
          const nonstd::string_view& user_id,
          const LanguageSettings& _content_) const;
  ...
  class SCOPES {
   public:
     ...
     */
    static const char GMAIL_ADDONS_CURRENT_ACTION_COMPOSE[];

    /**
     * View your email messages when you interact with the add-on.
     */
    static const char GMAIL_ADDONS_CURRENT_MESSAGE_ACTION[];

    /**
     * View your email message metadata when the add-on is running.
     */
    static const char GMAIL_ADDONS_CURRENT_MESSAGE_METADATA[];

    /**
     * View your email messages when the add-on is running.
     */
    static const char GMAIL_ADDONS_CURRENT_MESSAGE_READONLY[];
