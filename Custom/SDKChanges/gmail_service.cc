...
#include "google/gmail_api/batch_modify_messages_request.h"
#include "google/gmail_api/delegate.h"
...
#include "google/gmail_api/language_settings.h"
#include "google/gmail_api/list_delegates_response.h"
...
#include "google/gmail_api/list_smime_info_response.h"
...
const char GmailService::SCOPES::GMAIL_ADDONS_CURRENT_ACTION_COMPOSE[] = {"https://www.googleapis.com/auth/gmail.addons.current.action.compose"};

const char GmailService::SCOPES::GMAIL_ADDONS_CURRENT_MESSAGE_ACTION[] = {"https://www.googleapis.com/auth/gmail.addons.current.message.action"};

const char GmailService::SCOPES::GMAIL_ADDONS_CURRENT_MESSAGE_METADATA[] = {"https://www.googleapis.com/auth/gmail.addons.current.message.metadata"};

const char GmailService::SCOPES::GMAIL_ADDONS_CURRENT_MESSAGE_READONLY[] = {"https://www.googleapis.com/auth/gmail.addons.current.message.readonly"};
...
const char GmailService::SCOPES::GMAIL_METADATA[] = {"https://www.googleapis.com/auth/gmail.metadata"};
...
UsersResource_GetProfileMethod::UsersResource_GetProfileMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id)
...
UsersResource_WatchMethod::UsersResource_WatchMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const WatchRequest& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "{userId}/watch"),
...
// Standard constructor.
UsersResource_DraftsResource_CreateMethod::UsersResource_DraftsResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Draft* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "{userId}/drafts"),
...
UsersResource_DraftsResource_DeleteMethod::UsersResource_DraftsResource_DeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
...
// Standard constructor.
UsersResource_DraftsResource_UpdateMethod::UsersResource_DraftsResource_UpdateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const Draft* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/drafts/{id}"),
...
util::Status UsersResource_HistoryResource_ListMethod::AppendOptionalQueryParameters(string* target) {
  const char* sep = (target->find('?') == string::npos) ? "?" : "&";
  if (_have_history_types_) {
    if (!history_types_.empty()) {
      target->append(sep);
      client::AppendIteratorToUrl(
        history_types_.begin(), history_types_.end(),
        "historyTypes", target);
      sep = "&";
    }
  }
...
UsersResource_LabelsResource_CreateMethod::UsersResource_LabelsResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Label& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "{userId}/labels"),
...
UsersResource_LabelsResource_PatchMethod::UsersResource_LabelsResource_PatchMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const Label& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
...
UsersResource_MessagesResource_BatchDeleteMethod::UsersResource_MessagesResource_BatchDeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const BatchDeleteMessagesRequest& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
// Standard constructor.
UsersResource_MessagesResource_BatchModifyMethod::UsersResource_MessagesResource_BatchModifyMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const BatchModifyMessagesRequest& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
// Standard constructor.
UsersResource_MessagesResource_ImportMethod::UsersResource_MessagesResource_ImportMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Message* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
        "{userId}/messages/import"),
...
UsersResource_MessagesResource_ModifyMethod::UsersResource_MessagesResource_ModifyMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const ModifyMessageRequest& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_MessagesResource_AttachmentsResource_GetMethod::UsersResource_MessagesResource_AttachmentsResource_GetMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& message_id, const nonstd::string_view& id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
        "me/messages/"),
...
// Standard constructor.
UsersResource_SettingsResource_GetLanguageMethod::UsersResource_SettingsResource_GetLanguageMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status UsersResource_SettingsResource_GetLanguageMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
...
UsersResource_SettingsResource_UpdateAutoForwardingMethod::UsersResource_SettingsResource_UpdateAutoForwardingMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const AutoForwarding& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/settings/autoForwarding"),
...
UsersResource_SettingsResource_UpdateImapMethod::UsersResource_SettingsResource_UpdateImapMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const ImapSettings& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/settings/imap"),
...
// Standard constructor.
UsersResource_SettingsResource_UpdateLanguageMethod::UsersResource_SettingsResource_UpdateLanguageMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const LanguageSettings& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/settings/language"),
...
util::Status UsersResource_SettingsResource_UpdateLanguageMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
...
UsersResource_SettingsResource_UpdatePopMethod::UsersResource_SettingsResource_UpdatePopMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const PopSettings& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/settings/pop"),
...
UsersResource_SettingsResource_UpdateVacationMethod::UsersResource_SettingsResource_UpdateVacationMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const VacationSettings& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PUT,
        "{userId}/settings/vacation"),
...
// Standard constructor.
UsersResource_SettingsResource_DelegatesResource_CreateMethod::UsersResource_SettingsResource_DelegatesResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Delegate& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
util::Status UsersResource_SettingsResource_DelegatesResource_CreateMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
...
// Standard constructor.
UsersResource_SettingsResource_DelegatesResource_DeleteMethod::UsersResource_SettingsResource_DelegatesResource_DeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& delegate_email)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::DELETE,
        "{userId}/settings/delegates/{delegateEmail}"),
      user_id_(user_id),
      delegate_email_(delegate_email) {
}
...
util::Status UsersResource_SettingsResource_DelegatesResource_DeleteMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
  ...
  if (variable_name == "delegateEmail") {
    client::UriTemplate::AppendValue(
        delegate_email_, config, target);
    return client::StatusOk();
  }
  return GmailServiceBaseRequest::AppendVariable(
      variable_name, config, target);
...
// Standard constructor.
UsersResource_SettingsResource_DelegatesResource_GetMethod::UsersResource_SettingsResource_DelegatesResource_GetMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& delegate_email)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status UsersResource_SettingsResource_DelegatesResource_GetMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
...
// Standard constructor.
UsersResource_SettingsResource_DelegatesResource_ListMethod::UsersResource_SettingsResource_DelegatesResource_ListMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
util::Status UsersResource_SettingsResource_DelegatesResource_ListMethod::AppendVariable(
        const StringPiece& variable_name,
        const client::UriTemplateConfig& config,
        string* target) {
  if (variable_name == "userId") {
...
UsersResource_SettingsResource_FiltersResource_CreateMethod::UsersResource_SettingsResource_FiltersResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Filter& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_SettingsResource_ForwardingAddressesResource_CreateMethod::UsersResource_SettingsResource_ForwardingAddressesResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const ForwardingAddress& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod::UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& forwarding_email)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::DELETE,
        "{userId}/settings/forwardingAddresses/{forwardingEmail}"),
      user_id_(user_id),
      forwarding_email_(forwarding_email) {
}
...
UsersResource_SettingsResource_SendAsResource_CreateMethod::UsersResource_SettingsResource_SendAsResource_CreateMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const SendAs& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_SettingsResource_SendAsResource_DeleteMethod::UsersResource_SettingsResource_SendAsResource_DeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::DELETE,
        "{userId}/settings/sendAs/{sendAsEmail}"),
      user_id_(user_id),
      send_as_email_(send_as_email) {
}
...
UsersResource_SettingsResource_SendAsResource_PatchMethod::UsersResource_SettingsResource_SendAsResource_PatchMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const SendAs& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::PATCH,
        "{userId}/settings/sendAs/{sendAsEmail}"),
...
// Standard constructor.
UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_DeleteMethod::UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_DeleteMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::DELETE,
...
// Standard constructor.
UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_GetMethod::UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_GetMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
// Standard constructor.
UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_InsertMethod::UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_InsertMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const SmimeInfo& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
// Standard constructor.
UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_ListMethod::UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_ListMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::GET,
...
// Standard constructor.
UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_SetDefaultMethod::UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_SetDefaultMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_ThreadsResource_ModifyMethod::UsersResource_ThreadsResource_ModifyMethod(
    const GmailService* _service_, client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const ModifyThreadRequest& __request_content__)
    : GmailServiceBaseRequest(
        _service_, _credential_,
        client::HttpRequest::POST,
...
UsersResource_GetProfileMethod* GmailService::UsersResource::NewGetProfileMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_GetProfileMethod(service_, _credential_, user_id);
}


UsersResource_StopMethod* GmailService::UsersResource::NewStopMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_StopMethod(service_, _credential_, user_id);
}


UsersResource_WatchMethod* GmailService::UsersResource::NewWatchMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const WatchRequest& __request_content__) const {
...
UsersResource_DraftsResource_CreateMethod* GmailService::UsersResource::DraftsResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_DraftsResource_CreateMethod(service_, _credential_, user_id);
}

UsersResource_DraftsResource_CreateMethod* GmailService::UsersResource::DraftsResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Draft* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
UsersResource_DraftsResource_DeleteMethod* GmailService::UsersResource::DraftsResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_DraftsResource_DeleteMethod(service_, _credential_, user_id, id);
}


UsersResource_DraftsResource_GetMethod* GmailService::UsersResource::DraftsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_DraftsResource_GetMethod(service_, _credential_, user_id, id);
}


UsersResource_DraftsResource_ListMethod* GmailService::UsersResource::DraftsResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_DraftsResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_DraftsResource_ListMethodPager* GmailService::UsersResource::DraftsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
// This factory method is deprecated in favor of the newer variation that
// also takes the media upload parameters.
UsersResource_DraftsResource_SendMethod* GmailService::UsersResource::DraftsResource::NewSendMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_DraftsResource_SendMethod(service_, _credential_, user_id);
}

UsersResource_DraftsResource_SendMethod* GmailService::UsersResource::DraftsResource::NewSendMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Draft* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
// This factory method is deprecated in favor of the newer variation that
// also takes the media upload parameters.
UsersResource_DraftsResource_UpdateMethod* GmailService::UsersResource::DraftsResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_DraftsResource_UpdateMethod(service_, _credential_, user_id, id);
}

UsersResource_DraftsResource_UpdateMethod* GmailService::UsersResource::DraftsResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const Draft* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
UsersResource_HistoryResource_ListMethod* GmailService::UsersResource::HistoryResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_HistoryResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_HistoryResource_ListMethodPager* GmailService::UsersResource::HistoryResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
UsersResource_LabelsResource_CreateMethod* GmailService::UsersResource::LabelsResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Label& __request_content__) const {
  return new UsersResource_LabelsResource_CreateMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_LabelsResource_DeleteMethod* GmailService::UsersResource::LabelsResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_LabelsResource_DeleteMethod(service_, _credential_, user_id, id);
}


UsersResource_LabelsResource_GetMethod* GmailService::UsersResource::LabelsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_LabelsResource_GetMethod(service_, _credential_, user_id, id);
}


UsersResource_LabelsResource_ListMethod* GmailService::UsersResource::LabelsResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_LabelsResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_LabelsResource_PatchMethod* GmailService::UsersResource::LabelsResource::NewPatchMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const Label& __request_content__) const {
  return new UsersResource_LabelsResource_PatchMethod(service_, _credential_, user_id, id, __request_content__);
}


UsersResource_LabelsResource_UpdateMethod* GmailService::UsersResource::LabelsResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const Label& __request_content__) const {
...
UsersResource_MessagesResource_BatchDeleteMethod* GmailService::UsersResource::MessagesResource::NewBatchDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const BatchDeleteMessagesRequest& __request_content__) const {
  return new UsersResource_MessagesResource_BatchDeleteMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_MessagesResource_BatchModifyMethod* GmailService::UsersResource::MessagesResource::NewBatchModifyMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const BatchModifyMessagesRequest& __request_content__) const {
  return new UsersResource_MessagesResource_BatchModifyMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_MessagesResource_DeleteMethod* GmailService::UsersResource::MessagesResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_MessagesResource_DeleteMethod(service_, _credential_, user_id, id);
}


UsersResource_MessagesResource_GetMethod* GmailService::UsersResource::MessagesResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
...
// This factory method is deprecated in favor of the newer variation that
// also takes the media upload parameters.
UsersResource_MessagesResource_ImportMethod* GmailService::UsersResource::MessagesResource::NewImportMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_MessagesResource_ImportMethod(service_, _credential_, user_id);
}

UsersResource_MessagesResource_ImportMethod* GmailService::UsersResource::MessagesResource::NewImportMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Message* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
// This factory method is deprecated in favor of the newer variation that
// also takes the media upload parameters.
UsersResource_MessagesResource_InsertMethod* GmailService::UsersResource::MessagesResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_MessagesResource_InsertMethod(service_, _credential_, user_id);
}

UsersResource_MessagesResource_InsertMethod* GmailService::UsersResource::MessagesResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Message* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
UsersResource_MessagesResource_ListMethod* GmailService::UsersResource::MessagesResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_MessagesResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_MessagesResource_ListMethodPager* GmailService::UsersResource::MessagesResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
UsersResource_MessagesResource_ModifyMethod* GmailService::UsersResource::MessagesResource::NewModifyMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const ModifyMessageRequest& __request_content__) const {
...
// This factory method is deprecated in favor of the newer variation that
// also takes the media upload parameters.
UsersResource_MessagesResource_SendMethod* GmailService::UsersResource::MessagesResource::NewSendMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_MessagesResource_SendMethod(service_, _credential_, user_id);
}

UsersResource_MessagesResource_SendMethod* GmailService::UsersResource::MessagesResource::NewSendMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Message* _metadata_, const StringPiece& _media_content_type_, client::DataReader* _media_content_reader_) const {
...
UsersResource_MessagesResource_TrashMethod* GmailService::UsersResource::MessagesResource::NewTrashMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_MessagesResource_TrashMethod(service_, _credential_, user_id, id);
}


UsersResource_MessagesResource_UntrashMethod* GmailService::UsersResource::MessagesResource::NewUntrashMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
...
UsersResource_MessagesResource_AttachmentsResource_GetMethod* GmailService::UsersResource::MessagesResource::AttachmentsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& message_id, const nonstd::string_view& id) const {
...
GmailService::UsersResource::SettingsResource::SettingsResource(GmailService* service)
  : service_(service), delegates_(service), filters_(service), forwarding_addresses_(service), send_as_(service) {
}



UsersResource_SettingsResource_GetAutoForwardingMethod* GmailService::UsersResource::SettingsResource::NewGetAutoForwardingMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_GetAutoForwardingMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_GetImapMethod* GmailService::UsersResource::SettingsResource::NewGetImapMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_GetImapMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_GetLanguageMethod* GmailService::UsersResource::SettingsResource::NewGetLanguageMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_GetLanguageMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_GetPopMethod* GmailService::UsersResource::SettingsResource::NewGetPopMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_GetPopMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_GetVacationMethod* GmailService::UsersResource::SettingsResource::NewGetVacationMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_GetVacationMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_UpdateAutoForwardingMethod* GmailService::UsersResource::SettingsResource::NewUpdateAutoForwardingMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const AutoForwarding& __request_content__) const {
  return new UsersResource_SettingsResource_UpdateAutoForwardingMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_UpdateImapMethod* GmailService::UsersResource::SettingsResource::NewUpdateImapMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const ImapSettings& __request_content__) const {
  return new UsersResource_SettingsResource_UpdateImapMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_UpdateLanguageMethod* GmailService::UsersResource::SettingsResource::NewUpdateLanguageMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const LanguageSettings& __request_content__) const {
  return new UsersResource_SettingsResource_UpdateLanguageMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_UpdatePopMethod* GmailService::UsersResource::SettingsResource::NewUpdatePopMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const PopSettings& __request_content__) const {
  return new UsersResource_SettingsResource_UpdatePopMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_UpdateVacationMethod* GmailService::UsersResource::SettingsResource::NewUpdateVacationMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const VacationSettings& __request_content__) const {
  return new UsersResource_SettingsResource_UpdateVacationMethod(service_, _credential_, user_id, __request_content__);
}



GmailService::UsersResource::SettingsResource::DelegatesResource::DelegatesResource(GmailService* service)
  : service_(service) {
}



UsersResource_SettingsResource_DelegatesResource_CreateMethod* GmailService::UsersResource::SettingsResource::DelegatesResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Delegate& __request_content__) const {
  return new UsersResource_SettingsResource_DelegatesResource_CreateMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_DelegatesResource_DeleteMethod* GmailService::UsersResource::SettingsResource::DelegatesResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& delegate_email) const {
  return new UsersResource_SettingsResource_DelegatesResource_DeleteMethod(service_, _credential_, user_id, delegate_email);
}


UsersResource_SettingsResource_DelegatesResource_GetMethod* GmailService::UsersResource::SettingsResource::DelegatesResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& delegate_email) const {
  return new UsersResource_SettingsResource_DelegatesResource_GetMethod(service_, _credential_, user_id, delegate_email);
}


UsersResource_SettingsResource_DelegatesResource_ListMethod* GmailService::UsersResource::SettingsResource::DelegatesResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_DelegatesResource_ListMethod(service_, _credential_, user_id);
}
...
UsersResource_SettingsResource_FiltersResource_CreateMethod* GmailService::UsersResource::SettingsResource::FiltersResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const Filter& __request_content__) const {
  return new UsersResource_SettingsResource_FiltersResource_CreateMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_FiltersResource_DeleteMethod* GmailService::UsersResource::SettingsResource::FiltersResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_SettingsResource_FiltersResource_DeleteMethod(service_, _credential_, user_id, id);
}


UsersResource_SettingsResource_FiltersResource_GetMethod* GmailService::UsersResource::SettingsResource::FiltersResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_SettingsResource_FiltersResource_GetMethod(service_, _credential_, user_id, id);
}


UsersResource_SettingsResource_FiltersResource_ListMethod* GmailService::UsersResource::SettingsResource::FiltersResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
UsersResource_SettingsResource_ForwardingAddressesResource_CreateMethod* GmailService::UsersResource::SettingsResource::ForwardingAddressesResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const ForwardingAddress& __request_content__) const {
...
UsersResource_SettingsResource_ForwardingAddressesResource_DeleteMethod* GmailService::UsersResource::SettingsResource::ForwardingAddressesResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& forwarding_email) const {
...
UsersResource_SettingsResource_ForwardingAddressesResource_GetMethod* GmailService::UsersResource::SettingsResource::ForwardingAddressesResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& forwarding_email) const {
...
UsersResource_SettingsResource_ForwardingAddressesResource_ListMethod* GmailService::UsersResource::SettingsResource::ForwardingAddressesResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
GmailService::UsersResource::SettingsResource::SendAsResource::SendAsResource(GmailService* service)
  : service_(service), smime_info_(service) {
}



UsersResource_SettingsResource_SendAsResource_CreateMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewCreateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const SendAs& __request_content__) const {
  return new UsersResource_SettingsResource_SendAsResource_CreateMethod(service_, _credential_, user_id, __request_content__);
}


UsersResource_SettingsResource_SendAsResource_DeleteMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email) const {
  return new UsersResource_SettingsResource_SendAsResource_DeleteMethod(service_, _credential_, user_id, send_as_email);
}


UsersResource_SettingsResource_SendAsResource_GetMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email) const {
  return new UsersResource_SettingsResource_SendAsResource_GetMethod(service_, _credential_, user_id, send_as_email);
}


UsersResource_SettingsResource_SendAsResource_ListMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_SettingsResource_SendAsResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_SettingsResource_SendAsResource_PatchMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewPatchMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const SendAs& __request_content__) const {
...
UsersResource_SettingsResource_SendAsResource_UpdateMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewUpdateMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const SendAs& __request_content__) const {
...
UsersResource_SettingsResource_SendAsResource_VerifyMethod* GmailService::UsersResource::SettingsResource::SendAsResource::NewVerifyMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email) const {
  return new UsersResource_SettingsResource_SendAsResource_VerifyMethod(service_, _credential_, user_id, send_as_email);
}



GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::SmimeInfoResource(GmailService* service)
  : service_(service) {
}



UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_DeleteMethod* GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id) const {
  return new UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_DeleteMethod(service_, _credential_, user_id, send_as_email, id);
}


UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_GetMethod* GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id) const {
  return new UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_GetMethod(service_, _credential_, user_id, send_as_email, id);
}


UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_InsertMethod* GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::NewInsertMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const SmimeInfo& __request_content__) const {
  return new UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_InsertMethod(service_, _credential_, user_id, send_as_email, __request_content__);
}


UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_ListMethod* GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email) const {
  return new UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_ListMethod(service_, _credential_, user_id, send_as_email);
}


UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_SetDefaultMethod* GmailService::UsersResource::SettingsResource::SendAsResource::SmimeInfoResource::NewSetDefaultMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& send_as_email, const nonstd::string_view& id) const {
  return new UsersResource_SettingsResource_SendAsResource_SmimeInfoResource_SetDefaultMethod(service_, _credential_, user_id, send_as_email, id);
}
...
UsersResource_ThreadsResource_DeleteMethod* GmailService::UsersResource::ThreadsResource::NewDeleteMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_ThreadsResource_DeleteMethod(service_, _credential_, user_id, id);
}


UsersResource_ThreadsResource_GetMethod* GmailService::UsersResource::ThreadsResource::NewGetMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_ThreadsResource_GetMethod(service_, _credential_, user_id, id);
}


UsersResource_ThreadsResource_ListMethod* GmailService::UsersResource::ThreadsResource::NewListMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
  return new UsersResource_ThreadsResource_ListMethod(service_, _credential_, user_id);
}


UsersResource_ThreadsResource_ListMethodPager* GmailService::UsersResource::ThreadsResource::NewListMethodPager(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id) const {
...
UsersResource_ThreadsResource_ModifyMethod* GmailService::UsersResource::ThreadsResource::NewModifyMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id, const ModifyThreadRequest& __request_content__) const {
  return new UsersResource_ThreadsResource_ModifyMethod(service_, _credential_, user_id, id, __request_content__);
}


UsersResource_ThreadsResource_TrashMethod* GmailService::UsersResource::ThreadsResource::NewTrashMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
  return new UsersResource_ThreadsResource_TrashMethod(service_, _credential_, user_id, id);
}


UsersResource_ThreadsResource_UntrashMethod* GmailService::UsersResource::ThreadsResource::NewUntrashMethod(client::AuthorizationCredential* _credential_, const nonstd::string_view& user_id, const nonstd::string_view& id) const {
